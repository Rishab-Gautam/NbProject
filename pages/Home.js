              ...
              <Col span={8}>
                <div style={{ display: "flex" }}>
                  ...
                  >
                    ...
                    <br />
                    <h style={{ fontsize: '4px' }} >Whether you have an app, blog, YouTube channel, or want to
                    manage publicity for your college fest; !</h>
                  </h>
                </div>
              </Col>
              <Col span={8}>
...
"
        ...
        <div style={{ backgroundColor: "#FCF5FF" }}>
          <div style={{ backgroundcolor: "#f8f8f8", marginLeft: "480px" }}>
            <Title style={{ font: '28px proximanova-bold', color: '#444444', marginTop: '180px', top: '180px' }} level={5}>How will your doubt get solved</Title>
